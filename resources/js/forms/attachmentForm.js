		...
		if (validateForm() === true) {
			$('#submitAttachment').attr("disabled", "disabled");
			  $.ajax({
				 ...
				 cache:      false,
				 data:       { resourceAcquisitionID: $("#resourceAcquisitionID").val(), attachmentID: $("#editAttachmentID").val(), shortName: $("#shortName").val(), uploadDocument: fileName, descriptionText: $("#descriptionText").val(), attachmentTypeID: $("#attachmentTypeID").val()  },
