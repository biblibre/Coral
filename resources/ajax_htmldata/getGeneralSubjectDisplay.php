<?php
		...
		echo "<a href='ajax_forms.php?action=getAdminUpdateForm&className=" . $className . "&updateID=&height=128&width=260&modal=true' class='thickbox'>"._("add") . strtolower(preg_replace("/[A-Z]/", " \\0" , lcfirst($className))) . "</a>";
