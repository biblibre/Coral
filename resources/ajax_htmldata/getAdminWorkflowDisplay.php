<?php
		...
		if (count($userGroupArray) >0){
			echo "<span class='adminAdd'><a href='ajax_forms.php?action=getAdminWorkflowForm&workflowID=&height=528&width=750&modal=true' class='thickbox'>"._("add workflow")."</a></span>";
		}else{
